  ...
  return (
    <nav>
      <ul className={style.paginado}>
        ...
        {/* Se utiliza el método Array.from junto con la longitud de pageNumber para crear un array de la longitud correcta. Luego, se itera sobre este array y se renderiza un elemento de lista (li) para cada número de página. Cada elemento de lista contiene un botón con el número de página correspondiente y llama a la función paginado con el valor de index + 1 cuando se hace clic en él */}
